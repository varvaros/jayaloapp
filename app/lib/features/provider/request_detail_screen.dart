  ...
  Widget build(BuildContext context) {
    ...
    final scroll = CustomScrollView(slivers: [
        ...
        CollapsingPhotoPanel(
          ...
          // Compartir la solicitud DESDE EL LADO DEL PROVEEDOR. Faltaba: las
          // otras tres pantallas con boton son todas del lado cliente, asi que
          // un proveedor no veia ninguno (reporte del PO 2026-08-30). Va como
