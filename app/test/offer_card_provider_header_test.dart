...
void main() {
  ...
  testWidgets('con identidad y con sello: aparecen el nombre y el ✓', (
    tester,
  ) async {
  ...
  testWidgets('con identidad y sin ningún sello: aparece el nombre, NO el ✓', (
    tester,
  ) async {
    await tester.pumpWidget(
      wrap(OfferCardProviderHeader(info: info(name: 'Ferretería El Corito'))),
    );
