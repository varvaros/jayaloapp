...
void main() {
  test('todas las claves nuevas de onboarding existen y no van vacías', () {
    ...
    // por task: Tasks 6 (`client.catalog.v1`) y 7 (`chat.quick_replies.v1`,
    // `chat.report.v1`) añaden las suyas al aterrizar, para que la suite quede
    // verde en cada frontera de task.
    const keys = [
      'client.plus.v1',
